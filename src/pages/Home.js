...
const Home = () => {
    ...
    return (React.createElement("div", { className: "flex flex-col gap-8" },
        React.createElement("section", { className: "relative bg-gradient-to-r from-[#28d4a5] via-[#1f78d1] to-[#003f6f] text-white py-32 overflow-hidden" },
            React.createElement("div", { className: "absolute inset-0 bg-[url('/grid.svg')] bg-no-repeat bg-center opacity-20" }),
            React.createElement("div", { className: "container mx-auto px-4 relative z-10" },
                React.createElement("div", { className: "max-w-3xl" },
                    ...
                    React.createElement("div", { className: "flex gap-4" },
                        ...
                        React.createElement(Button, { variant: "outline", size: "lg", className: "border-[#28d4a5] text-[#28d4a5] hover:bg-[#1f78d1] hover:text-white" }, "Learn More"))))),
        React.createElement("section", { className: "container mx-auto px-4 py-16" },
            ...
            ].map((feature, index) => (React.createElement(Card, { key: index, className: "group hover:shadow-xl transition-all duration-300 border-t-4 border-[#28d4a5]" },
                React.createElement(CardHeader, null,
                    React.createElement("div", { className: "text-4xl mb-4 text-[#1f78d1]" }, feature.icon),
                    React.createElement(CardTitle, { className: "text-2xl group-hover:text-[#28d4a5] transition-colors" }, feature.title)),
                React.createElement(CardContent, null,
                    React.createElement("p", { className: "text-gray-600 mb-6" }, feature.description),
                    React.createElement(Button, { variant: "outline", className: "group-hover:bg-[#1f78d1] group-hover:text-white transition-all" }, "Learn More"))))))),
        React.createElement("section", { className: "bg-gray-50 py-20" },
            React.createElement("div", { className: "container mx-auto px-4" },
                React.createElement("div", { className: "max-w-4xl mx-auto text-center mb-16" },
                    React.createElement("h2", { className: "text-4xl font-bold mb-6 text-[#1f78d1]" }, "About Us"),
                ...
                React.createElement("div", { className: "grid md:grid-cols-2 gap-12 items-center" },
                    React.createElement("div", { className: "space-y-8" },
                        React.createElement("div", { className: "grid grid-cols-2 gap-6" }, [
                            ...
                            React.createElement("h4", { className: "text-3xl font-bold text-[#1f78d1] mb-2" }, stat.number),
                            React.createElement("p", { className: "text-gray-600" }, stat.label)))))),
                    React.createElement("div", { className: "relative" },
                        React.createElement("div", { className: "absolute inset-0 bg-gradient-to-r from-[#28d4a5] to-[#1f78d1] rounded-2xl transform rotate-3" }),
        ...
        React.createElement("section", { className: "py-20" },
            React.createElement("div", { className: "container mx-auto px-4" },
                ...
                React.createElement("div", { className: "grid md:grid-cols-2 gap-8" }, upcomingEvents
                    ...
                    React.createElement(CardHeader, null,
                        React.createElement(CardTitle, { className: "text-2xl group-hover:text-[#1f78d1] transition-colors" }, event.title)),
                    React.createElement(CardContent, null,
                        React.createElement("div", { className: "flex flex-col gap-4" },
                            React.createElement("div", { className: "flex items-center gap-3" },
                                React.createElement(CalendarIcon, { className: "w-5 h-5 text-[#28d4a5]" }),
                                React.createElement("span", { className: "text-gray-600" }, event.date)),
                            React.createElement("div", { className: "flex items-center gap-3" },
                                React.createElement(MapPinIcon, { className: "w-5 h-5 text-[#28d4a5]" }),
                            ...
                            React.createElement(Button, { className: "mt-4 w-full group-hover:bg-[#1f78d1] transition-colors" }, "Register Now"))))))))),
        React.createElement("section", { className: "bg-gradient-to-b from-gray-50 to-white py-20" },
            React.createElement("div", { className: "container mx-auto px-4" },
                ...
                React.createElement("div", { className: "grid md:grid-cols-3 gap-8" }, pastAchievements.map((achievement, index) => (React.createElement(Card, { key: index, className: "group hover:shadow-xl transition-all duration-300 overflow-hidden" },
                    React.createElement("div", { className: "h-2 bg-gradient-to-r from-[#28d4a5] to-[#1f78d1]" }),
                    React.createElement(CardHeader, null,
                        React.createElement(CardTitle, { className: "group-hover:text-[#1f78d1] transition-colors" }, achievement.title)),
                    React.createElement(CardContent, null,
